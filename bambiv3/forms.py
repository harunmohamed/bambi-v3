...
from wtforms.validators import DataRequired, Length, Email, EqualTo, ValidationError, Regexp, AlphaNumeric
from bambiv3.models import User

class RegistrationForm(FlaskForm):
	username = StringField('Username', validators = [DataRequired(), Length(min=2, max=20), AlphaNumeric()]) #Regexp(r'^[\w.-_.]+$', message='No Spaces. Use "-" or "_" or "." instead')
